...
#reader(lib "beginner-reader.rkt" "deinprogramm" "sdp")((modname Listen) (read-case-sensitive #f) (teachpacks ((lib "image.rkt" "teachpack" "deinprogramm" "sdp"))) (deinprogramm-settings #(#f write repeating-decimal #f #t none explicit #f ((lib "image.rkt" "teachpack" "deinprogramm" "sdp")))))
; ----- Listendefinition -----
...
; Die Ausgabe sieht linear aus, ist aber tatsächlich geschachtelt. Siehe Seite 176
...
; Gerüstbau: siehe Seite 177. Beachten Sie: (list-sum (rest list)) ... Der rest-Selektor hat einen Selbstbezug
