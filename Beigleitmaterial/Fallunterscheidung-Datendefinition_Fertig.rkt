...
#reader(lib "beginner-reader.rkt" "deinprogramm" "sdp")((modname Fallunterscheidung-Datendefinition_Fertig) (read-case-sensitive #f) (teachpacks ((lib "image.rkt" "teachpack" "deinprogramm" "sdp"))) (deinprogramm-settings #(#f write repeating-decimal #f #t none explicit #f ((lib "image.rkt" "teachpack" "deinprogramm" "sdp")))))
; Datendefinition:
